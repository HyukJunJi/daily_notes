...
Windows 작업 스케줄러를 활용한 개인 메모 자동화 시스템입니다. 아래 설정을 통해 매일 자동으로 노트를 생성하고 열 수 있습니다.
...
3. `register_tasks.bat`을 실행해 테스크를 Windows 작업 스케줄러에 등록합니다.

---

## 🖳️ 5. 테스크 해제

작업 스케줄러에서 테스크를 제거하려면 다음을 실행합니다:
